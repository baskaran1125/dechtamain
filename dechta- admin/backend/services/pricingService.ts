...
import { type InsertVehiclePricing, type VehiclePricing } from "../shared/schema";
...
export class PricingService {
  ...
  ): { baseFare: number; distanceCharge: number; totalCharge: number; breakdown: string } {
   ...
   */
  async getDeliveryEstimate(vehicleType: string, distanceKm: number) {
   ...
   */
  async getAllDeliveryEstimates(distanceKm: number) {
   ...
   */
  async createPricing(data: InsertVehiclePricing) {
   ...
   */
  async updatePricing(id: number, data: Partial<InsertVehiclePricing>) {
  ...
  async seedDefaultPricing() {
    const defaultPricing: InsertVehiclePricing[] = [

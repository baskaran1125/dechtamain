...
export class DriverService {
    ...
    async create(data) {
        const { aadharUrl, addressProofUrl, rcBookUrl, licenseUrl, photoUrl: docPhotoUrl, name, fullName, phone, email, vehicleType, vehicleNumber, licenseNumber, ...driverData } = data;

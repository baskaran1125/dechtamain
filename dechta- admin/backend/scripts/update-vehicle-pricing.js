...
async function checkAndUpdatePricing() {
    ...
    try {
        ...
        const updateResult = await client.query("UPDATE vehicle_pricing SET vehicle_type = '4W-1.4ton', display_name = '4 Wheeler - 1.4 Ton' WHERE vehicle_type = '4W-1.2ton' RETURNING *");
